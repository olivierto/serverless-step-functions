...
describe('#compileIamRole', () => {
  ...
  it('should give Redshift Data permissions for unsafe actions on all workg roups, given a name', () => {
  ...
  it('should give batch permissions (too permissive, but mirrors console behavior)', () => {
    const genStateMachine = id => ({
      id,
      definition: {
        StartAt: 'A',
  ...
  it('should give glue permissions (too permissive, but mirrors console behavior)', () => {
    const genStateMachine = id => ({
      id,
      definition: {
        StartAt: 'A',
  ...
  it('should give ECS permissions (too permissive, but mirrors console behavior)', () => {
    const genStateMachine = id => ({
      id,
      definition: {
        StartAt: 'A',
